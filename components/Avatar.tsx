...
const Avatar = () => {
  ...
  return (
    ...
    >
      ...
      {/* The photo itself: shown in its natural square/rectangular shape
          (uncropped), floating continuously and tilting toward the
          cursor. A soft edge fade blends the artwork's decorative lines
          into the background instead of cutting them off abruptly. */}
      <motion.div
        style={{
